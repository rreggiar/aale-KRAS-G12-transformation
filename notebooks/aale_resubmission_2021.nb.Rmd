...
bigWigs <- c('/public/groups/kimlab/aale-KRAS-G12-transformation/output.data/atac_out/bwa/mergedLibrary/bigwig/kras_R1.mLb.clN.bigWig',
             '/public/groups/kimlab/aale-KRAS-G12-transformation/output.data/atac_out/bwa/mergedLibrary/bigwig/ctrl_R1.mLb.clN.bigWig')

#Step-1. Extract the siganl for your loci of interst
track_data = track_extract(bigWigs = bigWigs, loci = "chr14:24,160,912-24,161,493")
