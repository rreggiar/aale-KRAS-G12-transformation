...
if (file.exists(file.path(output.data.dir, 'intra.aale.te_ranges_list.rds')) &
  ...
  intra.aale.te_ranges_list <- readRDS(file.path(output.data.dir, 'intra.aale.te_ranges_list.rds'))
  exo.aale.te_ranges_list <- readRDS(file.path(output.data.dir, 'exo.aale.te_ranges_list.rds'))
  hbec.aale.te_ranges_list <- readRDS(file.path(output.data.dir, 'hbec.aale.te_ranges_list.rds'))
