...
p4 <- ggplot(data.frame(l = 'TE [target of ZNF] RNA log2FoldChange', x = 1, y = 1)) +
      geom_text(aes(x, y, label = l), angle = 0, size = txt.mm_to_pts(0.8)) + 
      theme_void() +
      coord_cartesian(clip = "off")
...
wrap_plots(intra.aale.te_ranges_list$znf_plts$target_plt + theme(legend.position = c(0.3,0.3)) + ggtitle('ZNF motif binding'),
