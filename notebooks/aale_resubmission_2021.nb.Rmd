...
plot_big_wig_coverage <- function(chr, start, stop, 
  ...
  track_data$KRAS %>% 
    ...
    scale_y_continuous(limits = c(0, max(max_vector)), expand = c(0,0)) +
    ylab('coverage') + 
  ...
  ggplot(data = start_stop_df, 
    ...
    geom_segment(aes(x = gene_line_start, xend = gene_line_end), 
                 color = 'darkblue', size = 0.75, alpha = 0.1, arrow = arrow(ends = arrow_end)) +
...
plot_big_wig_coverage(chr = 'chr14', start = 24159500, stop = 24164100, 
                      label_diff = 120, gene_name = 'IRF9', break_denom = 4)
...
panel.save(figure = 2, 
           name = 'test_patch_znf_atac', width = 'double', height = 'single')
panel.save(figure = 2, 
