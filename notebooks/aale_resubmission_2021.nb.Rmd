...
system('sudo cp install_bin/bwtool /usr/local/bin/')
system('sudo apt -y install mysql-server')
...
install.packages(c('magick', 'cowplot', 'Hmisc'))
...
ggsave(plot = figure_4_patchwork.fig,
       filename = file.path(figure.dir, 'fig.4', 'figure_S3_patchwork.pdf'),
       width = patch_fig_width, height = patch_fig_height, device = cairo_pdf, units = 'mm')
```
## Figure S4
```{r}
