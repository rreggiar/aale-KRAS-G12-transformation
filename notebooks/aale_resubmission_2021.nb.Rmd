...
pdf(file.path(figure.dir, 'fig.1', 'test_table.pdf'), 
    width = unit(panel.figure.width, 'mm'),
    height = unit(panel.figure.height/3, 'mm'))
...
ggsave(plot = test_table,
       filename = file.path(figure.dir, 'fig.1', 'test_table.pdf'), 
       width = panel.figure.width, 
       height = panel.figure.height/3, units = 'mm')
