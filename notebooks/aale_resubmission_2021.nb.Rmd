...
build_date: "r format(Sys.time(), '%d %B, %Y')"
output:
  html_document:
    code_folding: hide
    self_contained: yes
...
install.packages(c('magick', 'cowplot', 'Hmisc', 'pdftools'))
...
model.plt <- magick::image_read_pdf(path = '/home/rreggiar/figures/fig.5/aale_model_cropped.pdf')
