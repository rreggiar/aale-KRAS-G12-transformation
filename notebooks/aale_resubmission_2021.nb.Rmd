...
seqs <- getSeq(BSgenome.Hsapiens.UCSC.hg38, rowRanges(salmon.quant$gxi))
...
GenomicFeatures::extractUpstreamSeqs(x = BSgenome.Hsapiens.UCSC.hg38, genes = sub_gr, width = 1000)
